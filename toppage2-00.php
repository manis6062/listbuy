    ...
    <td bgcolor="#FFFFFF"><table width="985" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="498"><a href="index.php"><img src="images/logo1.jpg" width="498" height="143" border="0" /></a></td>
            <td width="487" align="left" class="header_txt4">Welcome to the all new Website Marketplace! 
              You can find hundreds of websites for sale at any given time!</td>
          </tr>
          <tr>
            <td><table width="100%" border="0" cellspacing="15" cellpadding="0">
              <tr>
                <td><div class="header_txt1">Buy &amp; Sell</div>
                 <div class="header_txt2"> Websites</div></td>
                </tr>
              <tr>
                <td class="header_txt3">Domain and Website Auctions - Marketplace is a website which allows users to trade both established and new websites or domains. Unlike other website auction marketplaces, there is no hidden success fee. </td>
                </tr>
            </table></td>
            <td><table width="100%" border="0" cellspacing="15" cellpadding="0">
              <tr>
