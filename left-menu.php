...
<option value='' selected>All</option>
 ...
 <tr >
						<td valign="top" ><b>Income</b><br>
		<span style="color: #810436; font-size: 10px;">per month</span></td>
		<td>&nbsp;</td>
	<td><select name="income" style="width: 120px;" class="auswahl_2" enabled onchange="document.frm_advanced_search.elements.checkeddomains.checked = (document.frm_advanced_search.elements.visitors.selectedIndex == 0 ? true:false) ">
<option value='' selected>All</option>
 <option value='1'>1-500</option>
 <option value='2'>501-1000</option>
 <option value='3'>1001-5000</option>
 <option value='4'>5001-10000</option>
...
<?
	...
	?>
			<a href="buycredit.php">Buy more credits</a> 
			<a href="mylistings.php">My Listings</a> <a href="newlisting.php">Create Listing</a> <a href="placed-bids.php">Placed Bids</a> <a href="bin-offer.php">Placed BIN <?=$acc_bin['ABIN']!=0? "(".$acc_bin['ABIN'].")":""?></a> <a href="my-purchase.php">My Purchase</a> <a href="received-bids.php">Received Bids </a> <a href="bin-received.php">Received BINs <?=$total_bin['PBIN']!=''?"(".$total_bin['PBIN'].")":""?></a> <a href="my-message.php?mode=inbox">Private Messages(<?php echo $total_message['prim']==""?"0":$total_message['prim']?>)</a> <a href="short-list.php">My Shortlist</a> <a href="subscription-list.php">My Subscriptions<a href="change-password.php">Change Password</a> <a href="edit-profile.php">Edit Profile</a> <a href="payment-history.php">Payment History</a> <a href="logout.php">Logout</a>
<? }?>
...
<table width="216" border="0" cellspacing="0" cellpadding="0">
 <? /* <tr>
  ...
  <h2>Categories</h2>
	<?
	$cat_list=Listing_Qry("*",CATEGORY,"WHERE status='1' order by cat_id","");
	if($cat_list)
	{
	foreach($cat_list as $arrcat)
	{
	//echo "<a href='search.php?cat_id=$arrcat[cat_id]'>".$arrcat['cat_name']."</a>";
	echo "<a href='Category-".EdURL($arrcat[cat_name])."-$arrcat[cat_id].html'>".$arrcat['cat_name']."</a>";
	}
	}
  ...
  <tr>
   ...
   <tr>
	...
	<form name="frmemail" method="post" action="">
		  ...
		  <p style="text:18px;">Be first to get new updates, freebies and more...</p>
		    <br />
		    <?php echo $msgN?>
