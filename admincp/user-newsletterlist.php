...
if($_REQUEST['mode1'] == 'approve'){	
		...
		for($i=0;$i<sizeof($_REQUEST['chk']);$i++){
			$obap=Select_Qry("status",USERNEWSLETTER," id ='".$_REQUEST['chk'][$i]."'","","","","");
...
function jsHitListAction(p1)
	{			
		document.frm.action = "<?=$_SERVER['PHP_SELF']?>?page=user-newsletterlist&PageNo=" + eval(p1) ;
		document.frm.submit()
	}
	   ...
	   if(flag==0)
	    {
	       ...
	       if(con)
		    {
			document.frm.action="home.php?page=newslettermail";
		   		document.frm.submit();
				//return true;
		    }
			else 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                   ...
                   <!-- <td width="9%" align="center" valign="middle">
                    ...
                    Unpublish<br /></td>-->
					<td width="6%" align="center" valign="middle"><input type="button" name="btndelete" class="mailbttn" value="" onclick="return Confirm1('mail')" />
                    <br />Mail<br /></td>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0">
  ...
  <tr>
    <td width="9%" align="left" valign="top" class="tblborder">Sl. No </td>
    <td width="5%" align="left" valign="top" class="tblborder"><input type="checkbox" name="usrchk_all" onClick="AllSelect()" /></td>
	 <td width="61%" align="left" valign="top" class="tblborder">Email</td>
    <td width="25%" align="left" valign="top" class="tblborder">Created On</td>
    </tr>
  ...
  <tr bgcolor="<?php echo $bgColor;?>" class="onmouse">
    ...
    <td align="left" valign="top" class="tblborder1"><input type="checkbox" name="usrchk[]" value="<?=$obj_fetch["id"]?>" onClick="deselect_any()" /></td>
  ...
  ?>
  <tr>
    <td colspan="4" align="right" valign="top">Page No : <? include_once('pageno.php');?></td>
    </tr>
  ...
  ?>
  <tr>
    <td colspan="4" align="center" valign="top" class="error"><?=errormessage("No Newsletter currently available")?></td>
  </tr>
  <?
  }
  ?>
