...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					<span style="padding-left:10px; padding-top:8px; position:absolute;">Advertise Management  </span></td>
					<td width="10%" align="center" valign="top"><input type="submit" name="btnapprove" class="publishbttn" value="" onClick="return Confirm('approvesold')" /><br />
					Make Sold<br />
					</td>
					
                    <td width="10%" align="center" valign="top"><input type="submit" name="btnapprove" class="publishbttn" value="" onClick="return Confirm('approve')" /><br />
					Listed<br />
					</td>
					...
					<a href="home.php?page=post-advertise">
					<img src="images/new.png" border="0" width="31" height="30" /><br />
					</a>
                    Post Advertise<br /></td>
...
<tr>
<td width="13%" align="left" valign="top"><strong>Title </strong></td>
<td width="28%" align="left" valign="top"><input type="text" name="title" value="<?=$_REQUEST['title']?>" size="30" class="input"/></td><td width="10%" align="left" valign="top"><strong>Website</strong></td>
  <td width="29%" align="left" valign="top"><input type="text" name="website" value="<?=$_REQUEST['website']?>" size="30" class="input"/></td><td width="20%" align="left" valign="top"><input type="submit" value="Search" name="btnSubmit" class="bttn"/>&nbsp;<input type="button" name="viewall" value="Viewall" onclick="window.location.href='home.php?page=<?=$_REQUEST['page']?>'" class="bttn"/></td></tr>
</table></td>
<td width="10"><img src="images/7_05.png" width="6" height="64" /></td></tr></table></td>
  ...
  <tr bgcolor="<?php echo $bgColor;?>" class="onmouse">
    ...
    <td align="center" valign="top" class="tblborder1"><a href="javascript: statusCheck(<?php echo($obj_fetch['add_id']);?>,<?php echo($obj_fetch['status']);?>)" class="tooltipClass" onmouseover="return escape('<?=$obj_fetch['status']=='0'?'Relist' : 'Listed'?>')">
    ...
    <td width="10%" align="center" valign="top" class="tblborder1">
	<a href="home.php?page=post-advertise&id=<?=$obj_fetch['add_id']?>"><img src="images/edit.png" border="0" align="absmiddle" alt="Click Here to Edit"/></a></td>
    <td width="7%" align="center" valign="top" class="tblborder1"><a href="<?=$_SERVER['PHP_SELF']?>?page=user-list&mode=del&id=<?=$obj_fetch['add_id']?>"onclick="return confirm('Are you sure to delete')"><img src="images/delete.png" align="absmiddle" border="0" alt="Click Here to Delete"/></a></td>
  </tr>
  <?
  ...
  ?>
  <tr>
    <td colspan="10" align="center" valign="top" class="error"><?=errormessage("No advertise currently available")?></td>
  </tr>
  <?
  }
  ?>
