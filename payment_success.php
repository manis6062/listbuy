...
<p><span class="header_text_h"><?=static_cms_title(1)?></span>
  </p>
<p align="center">
<form name="frm" method="post" action="">
<table width="100%" border="0" cellspacing="3" cellpadding="4" align="center">
  <tr>
    <td align="center" valign="top"><?=statica_cms_page_value(1)?></td>
    </tr>
  <tr>
    <td align="center"><a href="my-account.php" class="greenfont">Continue to my listing.</a></td>
    </tr>
</table>
</form>
</p>
